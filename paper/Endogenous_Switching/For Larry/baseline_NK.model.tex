...
\end{equation}
\begin{equation}
\log{\pi^{\mathrm{obj}}_{t}} = \eta^{\pi}_{t} + {\rho^{\pi^{\mathrm{bar}}}} {\log{\pi^{\mathrm{obj}}_{t-1}}} + {\log{\pi^{\mathrm{target}}}} \left(1 - \rho^{\pi^{\mathrm{bar}}}\right)
\end{equation}
...
\end{equation}
\begin{equation}
\eta^{\pi}_{t} - \log{\pi^{\mathrm{obj}}_{t}} + {\rho^{\pi^{\mathrm{bar}}}} {\log{\pi^{\mathrm{obj}}_{t-1}}} + {\log{\pi^{\mathrm{target}}}} \left(1 - \rho^{\pi^{\mathrm{bar}}}\right) = 0
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
-\log{\pi^{\mathrm{obj}}_\mathrm{ss}} + {\rho^{\pi^{\mathrm{bar}}}} {\log{\pi^{\mathrm{obj}}_\mathrm{ss}}} + {\log{\pi^{\mathrm{target}}}} \left(1 - \rho^{\pi^{\mathrm{bar}}}\right) = 0
\end{equation}
\begin{equation}
