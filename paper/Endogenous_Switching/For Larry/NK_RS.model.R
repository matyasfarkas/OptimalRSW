...
ss_eq__ <- function(v, pc, pf)
{
    ...
    r[16] = -1 + pf[16] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1) + (1 - pf[16]) * v[10]^(-pf[7]^-1)
    r[17] = 1 - v[12] - v[13]
    r[18] = -v[2] + v[3] * (1 + pf[7])
    r[19] = -log(v[1]) + pf[14] * log(v[1])
    r[20] = -v[2] + v[5] * v[10] * v[28] + pf[2] * pf[16] * v[2] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1)
    r[21] = -v[3] + v[5] * v[6] * v[28] + pf[2] * pf[16] * v[3] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1 * (1 + pf[7]))
    r[22] = -v[7] + (1 - pf[16]) * v[10]^(-pf[7]^-1 * (1 + pf[7])) + pf[16] * v[7] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1 * (1 + pf[7]))
    r[23] = v[20] - v[21] + v[21] * (1 - pf[3])
    r[24] = v[26] - pf[2] * v[26] - (1 - pf[4])^-1 * (v[17]^pf[8] * (1 - v[22])^(1 - pf[8]))^(1 - pf[4])
    r[25] = -log(v[4]) - log(v[8]) + log(v[9])
    r[26] = -log(v[8]) + v[12] * log(pf[9]) + v[13] * log(v[9])
...
ss_calibr_eq_jacob__ <- function(v, pc, pf)
{
    ...
    jac[45] = v[5]
    jac[46] = -pf[7]^-1 * pf[16] * (-v[9]^-2 * v[9]^pf[5] + pf[5] * v[9]^-1 * v[9]^(-1 + pf[5])) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1)
    jac[47] = -pf[7]^-1 * (1 - pf[16]) * v[10]^(-1 - pf[7]^-1)
    jac[48] = -1
    jac[49] = -1
    jac[50] = -1
    jac[51] = 1 + pf[7]
    jac[52] = -v[1]^-1 + pf[14] * v[1]^-1
    jac[53] = -1 + pf[2] * pf[16] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1)
    jac[54] = v[10] * v[28]
    jac[55] = -pf[2] * pf[7]^-1 * pf[16] * v[2] * (-v[9]^-2 * v[9]^pf[5] + pf[5] * v[9]^-1 * v[9]^(-1 + pf[5])) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1)
    jac[56] = v[5] * v[28]
    jac[57] = v[5] * v[10]
    jac[58] = -1 + pf[2] * pf[16] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1 * (1 + pf[7]))
    jac[59] = v[6] * v[28]
    jac[60] = v[5] * v[28]
    jac[61] = -pf[2] * pf[7]^-1 * pf[16] * v[3] * (1 + pf[7]) * (-v[9]^-2 * v[9]^pf[5] + pf[5] * v[9]^-1 * v[9]^(-1 + pf[5])) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1 * (1 + pf[7]))
    jac[62] = v[5] * v[6]
    jac[63] = -1 + pf[16] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1 * (1 + pf[7]))
    jac[64] = -pf[7]^-1 * pf[16] * v[7] * (1 + pf[7]) * (-v[9]^-2 * v[9]^pf[5] + pf[5] * v[9]^-1 * v[9]^(-1 + pf[5])) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1 * (1 + pf[7]))
    jac[65] = -pf[7]^-1 * (1 + pf[7]) * (1 - pf[16]) * v[10]^(-1 - pf[7]^-1 * (1 + pf[7]))
    jac[66] = 1
    jac[67] = -pf[3]
...
pert1__ <- function(v, pc, pf)
{
    ...
    Atm1x[5] = -pf[5] * pf[7]^-1 * pf[16] * v[9]^-1 * v[9]^(-1 + pf[5]) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1)
    Atm1x[6] = pf[14] * v[1]^-1
    Atm1x[7] = pf[16] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1 * (1 + pf[7]))
    Atm1x[8] = -pf[5] * pf[7]^-1 * pf[16] * v[7] * v[9]^-1 * (1 + pf[7]) * v[9]^(-1 + pf[5]) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1 * (1 + pf[7]))
    Atm1x[9] = 1 - pf[3]
    Atm1x[10] = pf[13] * v[11]^-1
    Atm1x[11] = -v[15]
    Atm1x[12] = -v[9]^-1
    Atm1x[13] = pf[10] * v[9]^-1 * (1 - pf[12])
    Atm1x[14] = pf[12] * v[24]^-1
    Atm1x[15] = v[9]^-1
    Atm1x[16] = v[15]
    Atm1 <- sparseMatrix(i = c(6, 9, 10, 13, 16, 19, 22, 22, 23, 27,
                               28, 29, 30, 30, 31, 31),
                         j = c(21, 21, 21, 31, 9, 1, 7, 9, 21, 11,
                               21, 16, 9, 24, 16, 21),
    ...
    Atx[37] = v[5]
    Atx[38] = pf[7]^-1 * pf[16] * v[9]^-2 * v[9]^pf[5] * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1)
    Atx[39] = -pf[7]^-1 * (1 - pf[16]) * v[10]^(-1 - pf[7]^-1)
    Atx[40] = -1
    Atx[41] = -1
    Atx[42] = -1
    Atx[43] = 1 + pf[7]
    ...
    Atx[45] = -1
    Atx[46] = v[10] * v[28]
    Atx[47] = -pf[2] * pf[5] * pf[7]^-1 * pf[16] * v[2] * v[9]^-1 * v[9]^(-1 + pf[5]) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1)
    Atx[48] = v[5] * v[28] + pf[2] * pf[16] * v[2] * v[10]^-1 * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1)
    Atx[49] = v[5] * v[10]
    Atx[50] = -1
    Atx[51] = v[6] * v[28]
    Atx[52] = v[5] * v[28]
    Atx[53] = -pf[2] * pf[5] * pf[7]^-1 * pf[16] * v[3] * v[9]^-1 * (1 + pf[7]) * v[9]^(-1 + pf[5]) * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1 * (1 + pf[7]))
    Atx[54] = v[5] * v[6]
    Atx[55] = -1
    Atx[56] = pf[7]^-1 * pf[16] * v[7] * v[9]^-2 * (1 + pf[7]) * v[9]^pf[5] * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1 * (1 + pf[7]))
    Atx[57] = -pf[7]^-1 * (1 + pf[7]) * (1 - pf[16]) * v[10]^(-1 - pf[7]^-1 * (1 + pf[7]))
    Atx[58] = 1
    Atx[59] = -1
    ...
    Atp1x[6] = pf[2] * pf[16] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1)
    Atp1x[7] = pf[2] * pf[7]^-1 * pf[16] * v[2] * v[9]^-2 * v[9]^pf[5] * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1)
    Atp1x[8] = -pf[2] * pf[16] * v[2] * v[10]^-1 * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1)
    Atp1x[9] = pf[2] * pf[16] * (v[9]^-1 * v[9]^pf[5])^(-pf[7]^-1 * (1 + pf[7]))
    Atp1x[10] = pf[2] * pf[7]^-1 * pf[16] * v[3] * v[9]^-2 * (1 + pf[7]) * v[9]^pf[5] * (v[9]^-1 * v[9]^pf[5])^(-1 - pf[7]^-1 * (1 + pf[7]))
    Atp1x[11] = -pf[2]
