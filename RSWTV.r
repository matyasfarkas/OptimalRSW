...
# ############################################################################
setwd("C:/Users/fm007/Documents/GitHub/Optimal Gecon")
# load gEcon package
library(gEcon)

# make and load the model
rsw <- make_model("RSWTV.gcn")
...
rsw <- initval_calibr_par(rsw)
rsw <- steady_state(rsw, calibration = FALSE, use_jac = FALSE,
                    options_list = list(method = "Broyden", global = "gline",
                                        max_iter = 1000, tol = 1e-5, solver_status = TRUE))
